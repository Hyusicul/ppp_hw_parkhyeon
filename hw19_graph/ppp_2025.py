...
def main():
    ...
    after_birth = selected[selected["year"] >= 2003]
    ...
    print(f"2003년도 이후 가장 더웠던 6월 4일의 연도는{birth_after_max_tem_year}년, 기온은 {birth_after_max_tem}이며 가장 추웠던 연도는{birth_after_min_tem_year}년, 기온은{birth_after_min_tem}입니다.")
